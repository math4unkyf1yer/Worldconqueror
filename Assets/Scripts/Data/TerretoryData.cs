...
public class TerretoryData
{
    ...
    public TerretoryData TerritoryTier(int tierProduction, int tierCapacity)
    {
        float tProduction = tierProduction - 1;
        float tCapacity = tierCapacity - 1;

        switch (Type)// change production and capacity for the territory for now for the specific type
        {
